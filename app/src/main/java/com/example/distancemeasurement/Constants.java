...
public class Constants {
    ...
    public static final int OFFSET_MESSAGE_DEVICE_FOUND_REMOVED = 14;
    ...
    public static final String PREFERENCES_DEFAULT_STRING = "SNQz4YoYRL";
    public static final boolean PREFERENCES_DEFAULT_BOOLEAN = false;
